classdef prob_pc_relpose_4pst0_sir2v < problem
    properties
        N = 4;
    end
    methods
        ...
        function [eqs_sym, abbr_subs] = gen_eqs_sym(obj)
            ...
            for i = 1:obj.N
                ...
                F(3, :) = [-transpose(v) * in.q(:, i), transpose(v) * in.qq(:, i)];
        ...
        function [in_zp, out_zp] = rand_arg_zp(obj, p)
            [in_zp, out_zp] = vzp_rand_relpose_pinhole(obj.N, p, {'q', 'qq'}, {'v'}, 'ZeroScrewTransl', 'inner');
        end
        function [in_rl, out_rl] = rand_arg_rl(obj)
            [in_rl, out_rl] = vrl_rand_relpose_pinhole(obj.N, {'q', 'qq'}, {'v'}, 'ZeroScrewTransl', 'inner');
        end
    end
end